...
internal class UserValidation
{
    ...
    {
        bool validStartTime = DateTime.TryParseExact(startTime,"MM/dd/yyyy HH:mm",new CultureInfo(""),DateTimeStyles.None, out _);
        return validStartTime;
    }
    internal static bool EndTimeValidation(string endTime, string startTime)
    {
        bool validEndTime = DateTime.TryParseExact(endTime, "MM/dd/yyyy HH:mm", new CultureInfo(""), DateTimeStyles.None, out _) && Convert.ToDateTime(endTime) > Convert.ToDateTime(startTime);
